...
<body>
    ...
    <form name="form1" method="POST" action="form_incluir_pedido.php">
        ...
        <table border="0" align="center" width="60%">
            ...
            ?>
                <tr>
                    <td align="center">Nao ha nenhum pedido cadastrado.</td>
                </tr>
                <tr>
                    <td align="center"><input type="submit" value="Incluir Pedido"></td>
                </tr>
            <?php
            } else {
            ?>
                <tr>
                    <td colspan="3" align="center"><input type="submit" value="Incluir Novo Pedido"></td>
                </tr>
                <tr bgcolor="grey">
                    <td width="30%">Data Emissao</td>
                    <td width="20%">Observacao</td>
                    <td width="10%">Status</td>
                    <td width="20%">Endereco</td>
                    <td width="30%"></td>
                </tr>
                <?php
