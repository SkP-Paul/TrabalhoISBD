...
?>
<html>
<head><title>Filial.</title></head>
<body>
<center><h3>Filial</h3></center>
...
?>
  <tr><td align="center">Nao ha nenhuma filial cadastrada.</td></tr>
  <tr><td align="center"><input type="submit" value="incluir Filial"></td></tr>
<?php
}else{
?>
<tr><td colspan="3" align="center"><input type="submit" value="Incluir Nova Filial"></td></tr>
	<tr bgcolor="grey"><td width="20%">Nome</td><td width="20%">CNPJ</td><td width="30%">Endereço</td><td width="10%">Gerente</td><td width="30%"></td></tr>
<?php
