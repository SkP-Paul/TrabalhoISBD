...
<body>
    ...
    <form name="form1" method="POST" action="form_incluir_pessoa.php">
        ...
        <table border="0" align="center" width="60%">
            ...
            ?>
                <tr>
                    <td align="center">Nao ha nenhuma pessoa cadastrada.</td>
                </tr>
                <tr>
                    <td align="center"><input type="submit" value="incluir Pessoa"></td>
                </tr>
            <?php
            } else {
            ?>
                <tr>
                    <td colspan="3" align="center"><input type="submit" value="Incluir Nova Pessoa"></td>
                </tr>
                <tr bgcolor="grey">
                    <td width="30%">Nome</td>
                    <td width="20%">CPF</td>
